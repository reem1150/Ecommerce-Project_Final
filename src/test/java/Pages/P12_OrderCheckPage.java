...
public class P12_OrderCheckPage {

    public WebDriver driver;

    public P12_OrderCheckPage(WebDriver driver) {
        this.driver = driver;
    }
...
//        wait2.until(ExpectedConditions.textToBePresentInElement(element, "Checkout"));
                                    ...
                                    String address1, String postCode, String phoneNo, String faxNo)
    {
        ...
        WebDriverWait wait1 = new WebDriverWait(driver, Duration.ofSeconds(15));
        wait1.until(ExpectedConditions.elementToBeClickable(checkoutFNamePOM));
        // Write Company Name
        ...
        //Select Country Name using visible text
    ...
    public void checkoutPayDataEle(String cardHolderName, String cardNumber, String cardCode)
    {
        ...
        //Select Credit Card Type from Value
