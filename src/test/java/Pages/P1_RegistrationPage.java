...
public class P1_RegistrationPage {
    ...
    By registerLinkPOM = By.className("ico-register");
    ...
    By registerCompPOM = By.cssSelector("input[name=\"Company\"]");
    By registerUnNewsPOM = By.cssSelector("label[for=\"Newsletter\"]");
    ...
    By registerAsser2POM = By.xpath("//div[@class=\"result\"]");
    ...
    public void registerDataEle(String FirstName, String LastName, String email, String pass, String CompName)
    {
        ...
        day.selectByValue("15"); //Select the option from Value
        // Select Month from VisibleText //
        Select month = new Select(driver.findElement(registerMonthPOM));
        month.selectByVisibleText("August"); //Select the option using visible text //
        // Select Year from Value //
        Select year = new Select(driver.findElement(registerYearPOM));
        year.selectByValue("1990"); //Select the option from Value
