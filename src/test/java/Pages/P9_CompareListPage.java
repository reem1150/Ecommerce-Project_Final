...
public class P9_CompareListPage {

    public WebDriver driver;

    public P9_CompareListPage(WebDriver driver) {
        this.driver = driver;
    }
    ...
    By compareProd3AsserPOM = By.xpath("//p[@class=\"content\"]");
    ...
    {
        // Add product 3 to Compare list using POM
