...
public class D10_WishlistStepDefinitions {

        P10_WishlistPage wishList = Hooks.PageBase.p10_wishlistPageElementsPOM();
        ...
        public void add_a_product_to_the_Wishlist() {
            // Add product 1 to Wishlist & Assert its existence using POM
        ...
        public void add_another_product_to_the_Wishlist() {
            // Add product 2 to Wishlist & Assert its existence using POM
