...
import Pages.P9_CompareListPage;
...
public class D9_CompareListStepDefinitions {
    P9_CompareListPage compare = Hooks.PageBase.p9_compareListPagePOM();

    @Given("logged user can add First Product to Compare list")
    public void add_First_Product_to_Compare_list() {
        // Add product 1 to Compare list using POM
    ...
    public void add_Second_Product_to_Compare_list() {
        // Add product 2 to Compare list using POM
    ...
    public void add_Third_Product_to_Compare_list() {
        // Add & Assert product 3 to Compare list using POM
    ...
    public void Delete_all_the_list() {
        ...
        Assert.assertEquals(compare.compareDeleteListEle(), expectedResult, "Error Message : Assertion False!");
